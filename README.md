<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=1E3A8A&height=200&section=header&text=SYS.INIT%20//%20Gaurav%20Kulkarni&fontSize=45&fontAlignY=35&animation=twinkling&fontColor=ffffff" />
</div>
...
### 📡 Active Radar (Current Orbit)

I am a **third-year university student** and a **Senior Developer at 8 Bits**. I don't just write syntax; I engineer high-throughput systems designed to handle complex edge cases, hardware telemetry, and massive data pipelines without dropping a single payload.

*   🔭 **Currently Architecting:** A Distributed Task Scheduler with zero-data-loss worker failover and FinCore, a strict ACID-compliant double-entry ledger.
*   ⚡ **Deep Dives:** Brute-forcing algorithmic constraints, clamping Stop-Loss Limit (SL-LMT) orders in algorithmic trading, and decoupling ML inference from main UI threads.
*   🌱 **Exploring:** Advanced DSA, Neural Network pipelines, and IoT edge computing via ESP8266 microcontrollers.
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=cpp,python,ts,nodejs,fastapi,react,aws,gcp,docker,redis,postgres&theme=dark&perline=11" alt="Tech Stack" />
</div>

---

### 🏗️ Skunkworks & Edge Experiments
...
<div align="center">
  <p><em>"Code is just syntax; architecture is how you think."</em></p>
  <h3><a href="mailto:your.email@gmail.com">Let's build the impossible. ↗</a></h3>
</div>
